...
simulate_coronal_scan_debug:
	...
	$(CC) -p -g -c simulate_coronal_scan.cpp $(IDIR) $(LIBS) $(MPIFLAGS) $(SRCFNSLOCFLG) -O0 -o simulate_coronal_scan.o
	$(CC) -p -g simulate_coronal_scan.o ./required_procedures/ipbackgroundCFR_fun.o -lgfortran $(IDIR) $(LIBS) $(SRCFNSLOCFLG) -O0 -o simulate_coronal_scan.x
